...
const companyFilterShcema = require("../schemas/companyFilter.json");
...
router.get("/", async function (req, res, next) {
  const q = req.query; // companies/?name=x?minEmployees=x?maxEmployees=x

  // converts query string to and integer. +q.minEmployee converts to a number
